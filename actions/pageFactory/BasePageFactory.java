...
//        return new WebDriverWait(driver, 30).until(ExpectedConditions.alertIsPresent());
    ...
    public void waitForListElementClickAble(WebDriver driver, WebElement element) {
    ...
    public void sendkeyToElement(WebDriver driver, WebElement element, String content) {
        element.clear();
        element.sendKeys(content);
    }

    public void clearToElement(WebDriver driver, WebElement element) {
        element.clear();
    }
